...
export const blockDefinitions = {
    ...
    '01_block_static':   { name: 'Static Block',        type: 'cube',       size: [1, 1, 1], offset: [0, 0, 0], cost: 1, mass: 1, tags: ['基本形状', '構造', '特殊'] },
    ...
    '03_pyramid':        { name: 'Pyramid',             type: 'pyramid',    size: [1, 1, 1], offset: [0.5, -0.5, -0.5], cost: 1, mass: 0.33, tags: ['基本形状', '構造'], icon: '△' },
    '04_invpyramid':     { name: 'Inverse Pyramid',     type: 'invpyramid', size: [1, 1, 1], offset: [0, 0, 0], cost: 1, mass: 0.67, tags: ['基本形状', '構造'] },
    '05_wedge_2':        { name: 'Wedge 1x2',           type: 'wedge',      size: [1, 1, 2], offset: [0, 0, 0.5], cost: 2, mass: 1, tags: ['基本形状', '構造'] },
    '06_pyramid_2':      { name: 'Pyramid 1x2',         type: 'pyramid',    size: [2, 1, 1], offset: [0.5, -0.5, -0.5], cost: 2, mass: 0.67, tags: ['基本形状', '構造'] },
    '07_invpyramid_2':   { name: 'Inverse Pyramid 1x2', type: 'invpyramid', size: [2, 1, 1], offset: [0.5, -0.5, -0.5], cost: 2, mass: 1.33, tags: ['基本形状', '構造'] },
    '08_wedge_4':        { name: 'Wedge 1x4',           type: 'wedge',      size: [1, 1, 4], offset: [0, 0, 1.5], cost: 4, mass: 2, tags: ['基本形状', '構造'] },
    '09_pyramid_4':      { name: 'Pyramid 1x4',         type: 'pyramid',    size: [4, 1, 1], offset: [0.5, -0.5, -0.5], cost: 4, mass: 1.33, tags: ['基本形状', '構造'] },
    '10_invpyramid_4':   { name: 'Inverse Pyramid 1x4', type: 'invpyramid', size: [4, 1, 1], offset: [0.5, -0.5, -0.5], cost: 4, mass: 2.67, tags: ['基本形状', '構造'] },
    '11_pyramid_2x2':    { name: 'Pyramid 2x2',         type: 'pyramid',    size: [2, 1, 2], offset: [0.5, -0.5, -0.5], cost: 4, mass: 1.33, tags: ['基本形状', '構造'] },
    '12_pyramid_2x4':    { name: 'Pyramid 2x4',         type: 'pyramid',    size: [4, 1, 2], offset: [0.5, -0.5, -0.5], cost: 8, mass: 2.67, tags: ['基本形状', '構造'] },
    '13_pyramid_4x4':    { name: 'Pyramid 4x4',         type: 'pyramid',    size: [4, 1, 4], offset: [0.5, -0.5, -0.5], cost: 16, mass: 5.33, tags: ['基本形状', '構造'] },
    '14_invpyramid_2x2': { name: 'Inverse Pyramid 2x2', type: 'invpyramid', size: [2, 1, 2], offset: [0.5, -0.5, -0.5], cost: 4, mass: 2.67, tags: ['基本形状', '構造'] },
    '15_invpyramid_2x4': { name: 'Inverse Pyramid 2x4', type: 'invpyramid', size: [4, 1, 2], offset: [0.5, -0.5, -0.5], cost: 8, mass: 5.33, tags: ['基本形状', '構造'] },
    '16_invpyramid_4x4': { name: 'Inverse Pyramid 4x4', type: 'invpyramid', size: [4, 1, 4], offset: [0.5, -0.5, -0.5], cost: 16, mass: 10.67, tags: ['基本形状', '構造'] },
