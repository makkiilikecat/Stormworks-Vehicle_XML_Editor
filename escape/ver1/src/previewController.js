...
import { blockGeometry, previewBlockMaterial, snapToGrid, BLOCK_SIZE_METERS } from './blockUtils.js';
...
export function initPreviewController(cam, scn) {
    camera = cam;
    scene = scn;
    previewBlock = new THREE.Mesh(blockGeometry, previewBlockMaterial);
