...
import { blockGeometry, normalMaterial } from '../models/BlockUtils.js';
import { DEFAULT_BLOCK_TYPE } from '../app/Constants.js'; // ★ DEFAULT_BLOCK_TYPE をインポート
...
export function placeBlock(position, orientationMatrix) {
    ...
    const newMaterial = normalMaterial.clone();
